...
static void
expect_string (const char *expected, const char *actual)
{
	assert (strcmp (expected, actual) == 0);
}

static void
test_reverse_basic (void)
{
	char value[] = "hello";
...
static void
test_nextChar_found_and_missing (void)
{
	char value[] = "abcda";
...
static void
test_skipComments_removes_comments_and_preserves_literals (void)
{
	char value[128] = "int a=1; // drop\nchar *s=\"//keep\"; /*block*/return 0; //tail\n";
	skipComments (value, sizeof (value));
	expect_string ("int a=1; \nchar *s=\"//keep\"; return 0; \n", value);
}

static void
test_fold_wraps_at_whitespace (void)
{
...
static void
test_fold_hyphenates_long_words (void)
{
...
static void
test_entab_collapses_spaces (void)
{
